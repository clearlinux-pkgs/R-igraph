...
Source0  : https://cran.r-project.org/src/contrib/igraph_1.4.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676050166
...
/usr/lib64/R/library/igraph/tests/testthat/test-psumtree.R
